...
def parse_TEdatas(datas, group='TCTSTK'):
    ...
    group : str, optional
        Group identifiers for paired data, e.g. TCSK, TCTSTK, TKXXTSC, by default 'TCTSTK'

    Returns
    -------
    dict
        A dict consists of grouped TEdatas (T, C, S) and Tmax
    '''
